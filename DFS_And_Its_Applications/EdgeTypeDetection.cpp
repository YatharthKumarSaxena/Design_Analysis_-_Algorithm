...
void Graph::DFS(int src){
    ...
    cout<<"\n\nPre Order: \n";
    for(int i=0; i<v; i++) cout<<i<<":- "<<pre[i]<<endl;
    cout<<"\nPost Order: \n";
    for(int i=0; i<v; i++) cout<<i<<":- "<<post[i]<<endl;
    cout<<"\nParent: \n";
    for(int i=0; i<v; i++) cout<<i<<":- "<<parent[i]<<endl;
...
int main(){
    ...
    cout<<"Program is based on Depth First Search Using Pre and Post Method\n";
